...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; Polynomial 2016.</strong> All rights reserved.
</footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?= base_url(); ?>assets/adminLTE/https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?= base_url(); ?>assets/adminLTE/https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
...
<!-- daterangepicker -->
<script src="<?= base_url(); ?>assets/adminLTE/https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
